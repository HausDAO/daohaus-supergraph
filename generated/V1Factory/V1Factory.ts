...
export class V1Factory extends ethereum.SmartContract {
  ...
  newDao(
    ...
    let result = super.call(
      "newDao",
      "newDao(address,uint256,uint256,uint256,uint256,uint256,uint256,uint256,string):(bool)",
      [
        ethereum.Value.fromAddress(_approvedToken),
        ...
        ethereum.Value.fromUnsignedBigInt(_abortWindow),
  ...
  registerDao(
    ...
    let result = super.call(
      "registerDao",
      "registerDao(address,address,string):(bool)",
      [
