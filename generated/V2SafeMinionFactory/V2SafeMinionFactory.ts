...
export class V2SafeMinionFactory__minionsResult {
  value0: Address;
  value1: string;
...
export class V2SafeMinionFactory extends ethereum.SmartContract {
  static bind(address: Address): V2SafeMinionFactory {
    return new V2SafeMinionFactory("V2SafeMinionFactory", address);
  }
  ...
  minions(param0: Address): V2SafeMinionFactory__minionsResult {
    let result = super.call("minions", "minions(address):(address,string)", [
      ethereum.Value.fromAddress(param0)
    ]);

    return new V2SafeMinionFactory__minionsResult(
      result[0].toAddress(),
      result[1].toString()
    );
  }
  ...
  try_minions(
    param0: Address
  ): ethereum.CallResult<V2SafeMinionFactory__minionsResult> {
    ...
    return ethereum.CallResult.fromValue(
      new V2SafeMinionFactory__minionsResult(
        value[0].toAddress(),
        value[1].toString()
      )
    );
