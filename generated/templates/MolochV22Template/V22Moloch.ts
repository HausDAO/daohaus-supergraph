...
export class SetShaman extends EthereumEvent {
...
export class Shaman extends EthereumEvent {
...
export class SpamPrevention extends EthereumEvent {
  get params(): SpamPrevention__Params {
    return new SpamPrevention__Params(this);
  }
}

export class SpamPrevention__Params {
  _event: SpamPrevention;

  constructor(event: SpamPrevention) {
    this._event = event;
  }
...
export class V22Moloch extends SmartContract {
  ...
  try_members(param0: Address): CallResult<V22Moloch__membersResult> {
  ...
  try_proposals(param0: BigInt): CallResult<V22Moloch__proposalsResult> {
  ...
  shamans(param0: Address): boolean {
    let result = super.call("shamans", [EthereumValue.fromAddress(param0)]);

    return result[0].toBoolean();
  }

  try_shamans(param0: Address): CallResult<boolean> {
    let result = super.tryCall("shamans", [EthereumValue.fromAddress(param0)]);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  spamPrevention(): BigInt {
    let result = super.call("spamPrevention", []);

    return result[0].toBigInt();
  }

  try_spamPrevention(): CallResult<BigInt> {
    let result = super.tryCall("spamPrevention", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  spamPreventionAddr(): Address {
    let result = super.call("spamPreventionAddr", []);

    return result[0].toAddress();
  }

  try_spamPreventionAddr(): CallResult<Address> {
    let result = super.tryCall("spamPreventionAddr", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
...
export class SetConfigCall extends EthereumCall {
...
export class SetShamanCall extends EthereumCall {
...
export class SetSharesLootCall extends EthereumCall {
