...
export class ActionDeleted extends EthereumEvent {
...
export class AvatarSet extends EthereumEvent {
...
export class ChangedGuard extends EthereumEvent {
...
export class ProposeNewAction extends EthereumEvent {
...
export class SafeMinion extends SmartContract {
  ...
  try_actions(param0: BigInt): CallResult<SafeMinion__actionsResult> {
  ...
  deleteAction(_proposalId: BigInt): boolean {
    let result = super.call("deleteAction", [
  ...
  try_deleteAction(_proposalId: BigInt): CallResult<boolean> {
    let result = super.tryCall("deleteAction", [
      EthereumValue.fromUnsignedBigInt(_proposalId)
    ]);
    if (result.reverted) {
      return new CallResult();
  ...
  executeAction(_proposalId: BigInt, _transactions: Bytes): boolean {
    let result = super.call("executeAction", [
      EthereumValue.fromUnsignedBigInt(_proposalId),
      EthereumValue.fromBytes(_transactions)
    ]);
  ...
  getGuard(): Address {
    let result = super.call("getGuard", []);

    return result[0].toAddress();
  }

  try_getGuard(): CallResult<Address> {
    let result = super.tryCall("getGuard", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  guard(): Address {
    let result = super.call("guard", []);

    return result[0].toAddress();
  }

  try_guard(): CallResult<Address> {
    let result = super.tryCall("guard", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  try_hashOperation(_transactions: Bytes): CallResult<Bytes> {
  ...
  try_isPassed(_proposalId: BigInt): CallResult<boolean> {
  ...
  multisendLibrary(): Address {
    let result = super.call("multisendLibrary", []);

    return result[0].toAddress();
  }

  try_multisendLibrary(): CallResult<Address> {
    let result = super.tryCall("multisendLibrary", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  proposeAction(
    ...
    let result = super.call("proposeAction", [
      EthereumValue.fromBytes(_transactions),
      EthereumValue.fromAddress(_withdrawToken),
      EthereumValue.fromUnsignedBigInt(_withdrawAmount),
      EthereumValue.fromString(_details),
      EthereumValue.fromBoolean(_memberOnlyEnabled)
    ]);
...
export class DeleteActionCall extends EthereumCall {
...
export class SetAvatarCall extends EthereumCall {
...
export class SetGuardCall extends EthereumCall {
