...
export class NeopolitanMinion extends ethereum.SmartContract {
  ...
  try_actions(
    param0: BigInt
  ): ethereum.CallResult<NeopolitanMinion__actionsResult> {
  ...
  try_signatures(
    param0: Bytes
  ): ethereum.CallResult<NeopolitanMinion__signaturesResult> {
    let result = super.tryCall(
      "signatures",
      "signatures(bytes32):(bytes32,bytes4,uint256,address)",
      [ethereum.Value.fromFixedBytes(param0)]
