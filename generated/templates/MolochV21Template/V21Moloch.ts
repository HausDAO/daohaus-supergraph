...
export class V21Moloch extends ethereum.SmartContract {
  ...
  try_proposals(
    param0: BigInt
  ): ethereum.CallResult<V21Moloch__proposalsResult> {
  ...
  try_members(param0: Address): ethereum.CallResult<V21Moloch__membersResult> {
    let result = super.tryCall(
      "members",
      "members(address):(address,uint256,uint256,bool,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
