...
export class DelegateAppointed extends ethereum.Event {
...
export class HausWithdraw extends ethereum.Event {
...
export class Impeachment extends ethereum.Event {
...
export class ProposeAppointment extends ethereum.Event {
...
export class SetUberHaus extends ethereum.Event {
...
export class UberhausMinion extends ethereum.SmartContract {
  ...
  HAUS(): Address {
    let result = super.call("HAUS", "HAUS():(address)", []);

    return result[0].toAddress();
  }

  try_HAUS(): ethereum.CallResult<Address> {
    let result = super.tryCall("HAUS", "HAUS():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  actions(param0: BigInt): UberhausMinion__actionsResult {
    let result = super.call(
      "actions",
      "actions(uint256):(address,uint256,address,address,address,bool,bytes)",
  ...
  try_actions(
    param0: BigInt
  ): ethereum.CallResult<UberhausMinion__actionsResult> {
  ...
  appointments(param0: BigInt): UberhausMinion__appointmentsResult {
    let result = super.call(
      "appointments",
      "appointments(uint256):(address,address,uint256,address,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );
  ...
  try_appointments(
    param0: BigInt
  ): ethereum.CallResult<UberhausMinion__appointmentsResult> {
    let result = super.tryCall(
      "appointments",
      "appointments(uint256):(address,address,uint256,address,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
  ...
  try_currentDelegate(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "currentDelegate",
      "currentDelegate():(address)",
      []
  ...
  delegateList(param0: BigInt): Address {
    let result = super.call("delegateList", "delegateList(uint256):(address)", [
      ethereum.Value.fromUnsignedBigInt(param0)
    ]);
  ...
  try_delegateList(param0: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "delegateList",
      "delegateList(uint256):(address)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  delegateRewardsFactor(): BigInt {
    let result = super.call(
      "delegateRewardsFactor",
      "delegateRewardsFactor():(uint256)",
      []
    );
  ...
  try_delegateRewardsFactor(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "delegateRewardsFactor",
      "delegateRewardsFactor():(uint256)",
      []
  ...
  delegates(param0: Address): UberhausMinion__delegatesResult {
    let result = super.call(
      "delegates",
      "delegates(address):(bool,bool,bool)",
  ...
  try_delegates(
    param0: Address
  ): ethereum.CallResult<UberhausMinion__delegatesResult> {
    let result = super.tryCall(
      "delegates",
      "delegates(address):(bool,bool,bool)",
      [ethereum.Value.fromAddress(param0)]
  ...
  executeAppointment(proposalId: BigInt): Address {
    let result = super.call(
      "executeAppointment",
      "executeAppointment(uint256):(address)",
      [ethereum.Value.fromUnsignedBigInt(proposalId)]
    );
  ...
  try_executeAppointment(proposalId: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "executeAppointment",
      "executeAppointment(uint256):(address)",
      [ethereum.Value.fromUnsignedBigInt(proposalId)]
  ...
  try_initialDelegate(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "initialDelegate",
      "initialDelegate():(address)",
      []
  ...
  nominateDelegate(
    ...
    let result = super.call(
      "nominateDelegate",
      "nominateDelegate(address,address,uint256,string):(uint256)",
      [
        ethereum.Value.fromAddress(targetDao),
        ethereum.Value.fromAddress(nominee),
        ethereum.Value.fromUnsignedBigInt(retireTime),
  ...
  proposeAction(
    ...
    let result = super.call(
      "proposeAction",
      "proposeAction(address,address,address,uint256,bytes,string):(uint256)",
      [
        ethereum.Value.fromAddress(targetDao),
  ...
  uberHaus(): Address {
    let result = super.call("uberHaus", "uberHaus():(address)", []);

    return result[0].toAddress();
  }

  try_uberHaus(): ethereum.CallResult<Address> {
    let result = super.tryCall("uberHaus", "uberHaus():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  updateUberHaus(_uberHaus: Address): Address {
    let result = super.call(
      "updateUberHaus",
      "updateUberHaus(address):(address)",
  ...
  try_updateUberHaus(_uberHaus: Address): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "updateUberHaus",
      "updateUberHaus(address):(address)",
      [ethereum.Value.fromAddress(_uberHaus)]
...
export class ApproveUberHausCall extends ethereum.Call {
...
export class ClaimDelegateRewardCall extends ethereum.Call {
...
export class ExecuteAppointmentCall extends ethereum.Call {
...
export class ImpeachDelegateCall extends ethereum.Call {
...
export class NominateDelegateCall extends ethereum.Call {
...
export class PullGuildFundsCall extends ethereum.Call {
...
export class SetInitialDelegateCall extends ethereum.Call {
...
export class UpdateUberHausCall extends ethereum.Call {
