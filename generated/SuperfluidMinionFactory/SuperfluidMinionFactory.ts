...
export class SuperfluidMinionFactory extends ethereum.SmartContract {
  ...
  minions(param0: Address): SuperfluidMinionFactory__minionsResult {
    let result = super.call(
      "minions",
      "minions(address):(address,address,string)",
  ...
  try_minions(
    param0: Address
  ): ethereum.CallResult<SuperfluidMinionFactory__minionsResult> {
  ...
  summonMinion(moloch: Address, _sfApp: Address, details: string): Address {
    let result = super.call(
      "summonMinion",
      "summonMinion(address,address,string):(address)",
      [
        ethereum.Value.fromAddress(moloch),
        ethereum.Value.fromAddress(_sfApp),
